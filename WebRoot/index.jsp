...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    	<div>
    		...
    		<center><h3 style="font-weight:bold;line-height:300px;">欢迎使用人社局后台管理系统</h3></center>
    		</div>
    		<div>
    			<center>
	    			<span>用户名：<input type="text" name="userName" maxlength="16"/></span>
	    			<span>密码：<input type="password" name="password" maxlength="16"/></span>
	    			<span>验证码：<input type="text" name="verifyCode" maxlength="4"/><img id="verifyImg"/>看不清?点击图片刷新</span>
	    			<span><input id="sub" type="submit" name="sub" value="登录" disabled="disabled"/></span>
    			</center>
    		</div>
